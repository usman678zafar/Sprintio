        ...
        <div className="ml-auto flex items-center gap-3 sm:gap-4">
          ...
          {(pathname === "/dashboard" || pathname === "/projects" || pathname === "/calendar") && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-[0_10px_20px_rgba(37,99,235,0.22)] transition hover:bg-blue-700 sm:px-5"
            >
              <Plus size={18} />
