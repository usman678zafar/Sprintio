    ...
    <div className="h-full overflow-y-auto bg-surface px-5 py-5">
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ children }) => <blockquote className="mt-4 rounded-r-2xl border-l-4 border-primary bg-primary/8 px-4 py-3 text-sm leading-7 text-text-base">{children}</blockquote>,
          ...
          img: ({ src, alt }) => <img src={src || ""} alt={alt || ""} className="mt-4 h-32 w-auto max-w-full rounded-2xl border border-border-subtle bg-base p-2 object-contain" />,
