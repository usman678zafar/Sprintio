...
export default function ProjectsClient({ initialProjects }: { initialProjects: Project[] }) {
    ...
    return (
        <div className="min-h-full bg-[#fcfdfe] px-4 py-8 sm:px-6 lg:px-10">
            <div className="mx-auto max-w-7xl">
                ...
                {/* Toolbar Section */}
                <section className="sticky top-0 z-30 mb-8 border-y border-slate-100 bg-[#fcfdfe]/80 py-4 backdrop-blur-md">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <span className="hidden text-sm font-bold text-slate-400 md:block">Sort by:</span>
                            <select
                                value={sortMode}
                ...
                {loading ? (
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {[1, 2, 3].map(i => (
                            <div key={i} className="h-64 animate-pulse rounded-[32px] bg-slate-100" />
                        ))}
                    </div>
